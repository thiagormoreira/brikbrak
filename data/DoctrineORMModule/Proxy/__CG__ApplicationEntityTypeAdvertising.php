 ...
 */
class TypeAdvertising extends \Application\Entity\TypeAdvertising implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\TypeAdvertising' . "\0" . 'typeAdvertising', '' . "\0" . 'Application\\Entity\\TypeAdvertising' . "\0" . 'typeName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeAdvertising $proxy) {
    ...
    public function getTypeAdvertising()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTypeAdvertising();
        }
