...
class Role extends \Application\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'roleId', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'isDefault', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'parent');
        }
