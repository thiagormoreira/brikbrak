...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'userId', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'displayName', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'state', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'address', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'contact', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'historyAccess', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'role');
        }
